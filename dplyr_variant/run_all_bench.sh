...
rm -rf ../results/dplyr_mem_fread_results
mkdir -p ../results/dplyr_mem_fread_results

PORT=7665
URL="http://127.0.0.1:${PORT}"

export BENCH_GLOBAL="mem_global.R"
export BENCH_VARIANT="../results/dplyr_mem_fread_results"

for i in $(seq 1 20); do
  echo
  echo "================================"
  echo "Running DPLYR - FREAD Mem Benchmark for log file $i"
  echo "================================"
...
rm -rf ../results/dplyr_readr_results
mkdir -p ../results/dplyr_readr_results
...
export BENCH_VARIANT="../results/dplyr_readr_results"

for i in $(seq 1 20); do
  echo
  echo "================================"
  echo "Running DPLYR - READR Speed Benchmark for log file $i"
  echo "================================"
...
rm -rf ../results/dplyr_mem_readr_results
mkdir -p ../results/dplyr_mem_readr_results

PORT=7665
URL="http://127.0.0.1:${PORT}"

export BENCH_GLOBAL="mem_global.R"
export BENCH_VARIANT="../results/dplyr_mem_readr_results"

for i in $(seq 1 20); do
  echo
  echo "================================"
  echo "Running DPLYR - READR Mem Benchmark for log file $i"
  echo "================================"
...
rm -rf ../results/dplyr_vroom_results
mkdir -p ../results/dplyr_vroom_results
...
export BENCH_VARIANT="../results/dplyr_vroom_results"

for i in $(seq 1 20); do
  echo
  echo "================================"
  echo "Running DPLYR - VROOM Speed Benchmark for log file $i"
  echo "================================"
